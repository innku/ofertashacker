...
* {Rails 3.2.3}[https://github.com/rails/rails/tree/v3.2.3]
...
6. Si quieres cargar datos de prueba como trabajos, habilidades y compañias puedes correr
...
7. Si quieres crear un trabajo nuevo con la forma, necesitas correr

    rake metropoli:seed

Nota: este paso no es necesario si corres paso 6.
...
* {Elías Matheus}[https://github.com/e3matheus]
...
Corre "cucumber -p plain" para correr las pruebas de integración que no usan javascript o "cucumber -p enhanced" para correr las pruebas de integración que si los usan. Para las pruebas unitarias de javascript, usamos {mocha}[https://github.com/jfirebaugh/konacha].
...
* Copyright 2011 INNKU Solutions SA de CV
