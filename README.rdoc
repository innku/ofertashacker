...
* Corre "rake cucumber" para correr nuestras pruebas de integración del backend. Para probar javascript, usamos {mocha}[https://github.com/jfirebaugh/konacha]. Como verás aun nos faltan bastantes, así que escoge un feature y escríbelo!
