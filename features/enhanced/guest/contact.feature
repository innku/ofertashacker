...
Feature: User Actions
  ...
  Scenario: I can contact a company
    ...
    And I fill in "message" with "Foo bar"
    And I press "Enviar mensaje"
    Then I should see "Tu mensaje fue enviado a Company1 correctamente."
  ...
  Scenario: I can't contact a company if I don't enter an email
    ...
    And I should not see "Tu mensaje fue enviado a Company1 correctamente."
