...
Feature: Admin Actions
  ...
  And I can see all required skills
  And I can edit a required skills
  And I can update a required skill
  And I can create a new required skill
  And I can delete a required skill 
